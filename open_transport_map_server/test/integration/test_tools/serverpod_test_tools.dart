...
import 'package:open_transport_map_server/src/generated/vehicles/vehicle_delta.dart'
    as _inhzfj46;
...
import 'package:open_transport_map_server/src/generated/endpoints.dart';
...
class TestEndpoints {
  ...
  late final _VehiclePositionsEndpoint vehiclePositions;
}
...
class _InternalTestEndpoints extends TestEndpoints
  ...
  void initialize(
    ...
    vehiclePositions = _VehiclePositionsEndpoint(
      endpoints,
      serializationManager,
    );
  }
...
class _VehiclePositionsEndpoint {
  _VehiclePositionsEndpoint(
    this._endpointDispatch,
    this._serializationManager,
  );
  ...
  _ida.Stream<_inhzfj46.VehicleDelta> watchVehicles(
    _ist.TestSessionBuilder sessionBuilder, {
    ...
    var _localTestStreamManager =
        _ist.TestStreamManager<_inhzfj46.VehicleDelta>();
    _ist.callStreamFunctionAndHandleExceptions(
      () async {
        var _localUniqueSession =
            (sessionBuilder as _ist.InternalTestSessionBuilder).internalBuild(
              endpoint: 'vehiclePositions',
              method: 'watchVehicles',
            );
        var _localCallContext = await _endpointDispatch
            .getMethodStreamCallContext(
              createSessionCallback: (_) => _localUniqueSession,
              endpointPath: 'vehiclePositions',
              methodName: 'watchVehicles',
              arguments: {
                'north': north,
                'south': south,
                'east': east,
